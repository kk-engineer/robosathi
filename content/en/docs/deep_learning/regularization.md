...
<span><a href="{{< ref "/docs/deep_learning/optimization_method" >}}">Previous: Optimization_Methods</a></span>
<span style="margin-left:auto;"><a href="{{< ref "/docs/deep_learning/batch_normalization" >}}">Next: Batch Normalization</a></span>
</div>
<!-- nav-panel:end -->
