...
{{< panel color="blue" title="Gaussian Mixture Model (GMM)" id="gmm" >}} 
...
_Note_: GMM assumes that all data points are generated from a **mixture** of a finite number of **Gaussian Distributions** 
