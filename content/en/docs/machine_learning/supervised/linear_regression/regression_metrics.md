...
<span style="margin-left:auto;"><a href="{{< ref "/docs/machine_learning/supervised/linear_regression/assumptions_of_linear_regression" >}}">Next: Assumptions of Linear Regression</a></span>
</div>
<!-- nav-panel:end -->
